...
import RentalerPayment from './page/rentaler/RentalerPayment';
    ...
    <>
      <Router>
        <Routes>
          ...
          <Route exact path="/rentaler/payment" element={<RentalerPayment authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />} />
